...
export const formations = [
  {
    ...
    image: '/c-sharp.webp',
    donneReyal: 'Introduction au C#', // Added donne reyal
    videoformations: [
      {
        id: 1,
        title: 'C# Basics',
        ...
        durition: '1h 30m',
        chapitre: [
          { id: 1, title: 'Introduction', duration: '30min', score: '10%' },
          { id: 2, title: 'Syntaxe de base', duration: '16min', score: '20%' },
          { id: 3, title: 'Structures de contrôle', duration: '12min', score: '40%' },
          { id: 4, title: 'Programmation orientée objet', duration: '15min', score: '60%' },
        ],
      },
    ],
  },
    ...
    videoformations: [
      {
        ...
        image: '/photoshop.jpg',
        video: 'https://www.youtube.com/embed/abcdefg12345',
        formationId: 2,
        durition: '2h 00m',
        chapitre: [
          { id: 1, title: 'Introduction à Photoshop', duration: '20min', score: '15%' },
          { id: 2, title: 'Les calques', duration: '25min', score: '25%' },
          { id: 3, title: 'Les outils de retouche', duration: '30min', score: '35%' },
        ],
      },
    ],
  },
    ...
    videoformations: [
      {
        ...
        image: '/java.webp',
        video: 'https://www.youtube.com/embed/ghijklm67890',
        formationId: 3,
        durition: '3h 00m',
        chapitre: [
          { id: 1, title: 'Introduction au langage Java', duration: '40min', score: '20%' },
          { id: 2, title: 'Les classes et objets', duration: '30min', score: '25%' },
          { id: 3, title: 'Les collections', duration: '50min', score: '30%' },
        ],
      },
    ],
  },
  {
    ...
    image: '/html.webp',
    donneReyal: 'Formation en Développement Web', // Added donne reyal
    videoformations: [
      {
        id: 1,
        ...
        image: '/html.webp',
        video: 'https://www.youtube.com/embed/opqrst56789',
        formationId: 4,
        durition: '2h 30m',
        chapitre: [
          { id: 1, title: 'Structure HTML', duration: '40min', score: '15%' },
          { id: 2, title: 'Mise en page avec CSS', duration: '60min', score: '30%' },
        ],
      },
    ],
  },
